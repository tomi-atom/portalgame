...
class _PortalGameHomePageState extends State<PortalGameHomePage> {
  List<Item> items = [
    ...
    Item(name: '26. Connect The Block ', image: 'assets/connecttheblocks300200.webp', link: 'https://cdn.htmlgames.com/ConnectTheBlocks/'),
    Item(name: '27. Solitaire', image: 'assets/easterislandsolitaire300200.webp', link: 'https://cdn.htmlgames.com/EasterIslandSolitaire/'),
    Item(name: '28. Connect The Dots', image: 'assets/connectthedots300200.webp', link: 'https://cdn.htmlgames.com/ConnectTheDots/'),
    Item(name: '29. Harbour Escape', image: 'assets/harbourescape300200.webp', link: 'https://cdn.htmlgames.com/HarbourEscape/'),
    Item(name: '30. Picture Pie Harbour', image: 'assets/picturepieharbourcity300200.webp', link: 'https://cdn.htmlgames.com/PicturePieHarbourCity/'),
